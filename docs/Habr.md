...
-   **Сбор телеметрии**: Читает дистанцию с сонара, температуру/влажность с Modulino и отправляет это в Backend/MPU.
...
Так что дерзайте! Роботы — это весело. Особенно когда они умеют злиться.
